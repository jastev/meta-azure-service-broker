...
// Functions meant to be called as async tasks.  Except for intializeState, all others
...
exports.createResourceGroup = function(state, callback) {
  //TODO Fix this hack to make common - move state.apimgmt.azure to state.azure
  var resource_group_name = state.apimgmt.azure.resourceGroup;
  var location = state.apimgmt.azure.location;
